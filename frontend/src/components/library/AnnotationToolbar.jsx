...
import { Eraser, Highlighter, PenSquare, RotateCcw, RotateCw, Square, Trash2, Type } from 'lucide-react';
...
const AnnotationToolbar = ({
  ...
  return (
    <div
      ...
      } rounded-xl border border-border bg-card/80 p-3 shadow-sm ${disabled ? 'opacity-80' : ''} ${className}`.trim()}
    ...
    >
      ...
      <div className={sectionClass}>
        <label className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Stroke</label>
