...
import RefundInvoiceModal from '../invoices/RefundInvoiceModal';
...
const InvoicesPage = () => {
  ...
  }, [debouncedSearch, sortBy, sortOrder, statusFilter, typeFilter, currentPage, activeTab, showDeleted]);
          ...
          <div className="mt-6 space-y-4">
            {loading && invoices.length === 0 ? (
              ...
              displayedInvoices.map((invoice) => {
                ...
                const invoicePaid = computed.paid;
                const remainingBalance = computed.remaining;
                
                // Use billing period directly from the invoice - don't recalculate
                const billingStart = invoice.billingPeriod?.startDate || invoice.billingPeriod?.start || invoice.billingPeriod?.start_date || invoice.createdAt;
                const billingEnd = invoice.billingPeriod?.endDate || invoice.billingPeriod?.end || invoice.billingPeriod?.end_date || invoice.endDate || null;
